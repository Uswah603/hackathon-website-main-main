...
form.addEventListener('submit', function (event) {
    ...
    // Generate a shareable URL with the username as the query parameter
...
// Prefill the form if a username is found in the URL
window.addEventListener('DOMContentLoaded', function () {
    var urlParams = new URLSearchParams(window.location.search);
    var username = urlParams.get('username');
    if (username) {
        // Check if resume data exists in localStorage for this username
